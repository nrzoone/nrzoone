...
import { GOOGLE_SHEET_URL, SMS_API_KEY, SMS_SENDER_ID, SMS_API_URL, WHATSAPP_PHONE, WHATSAPP_API_KEY, WHATSAPP_API_URL } from './config';
    ...
    const handleOrderSubmit = async (e) => {
        ...
        try {
            ...
            if (WHATSAPP_API_KEY && WHATSAPP_API_KEY !== 'XXXXXX') {
                const waMessage = `*নতুন হিজাব অর্ডার*\n\n*নাম:* ${formData.name}\n*ফোন:* ${formData.phone}\n*ঠিকানা:* ${formData.address}\n*ডিজাইন:* ${currentDesignObj.name}\n*কালার:* ${selectedColor}\n*সাইজ:* ${selectedSize}\n*টোটাল:* ${currentTotal} টাকা`;
