            ...
            <div className="bg-white w-full max-w-lg rounded-[3rem] overflow-hidden shadow-2xl relative border-4 border-white/20">
                <div className="p-8 border-b border-slate-50 flex justify-between items-center bg-white">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[8px] font-black uppercase text-black dark:text-slate-400 tracking-widest">NRZO0NE Core Intelligence</p>
                        </div>
                    </div>
                    <button 
                        onClick={onClose}
                ...
                <div className="p-8 bg-slate-50 flex flex-col gap-6">
                    ...
                    <button 
                        ...
                        className={`w-full py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-3 ${isBulk ? 'bg-emerald-500 text-white shadow-xl shadow-emerald-500/20' : 'bg-slate-100 text-black dark:text-slate-400 hover:text-black'}`}
                    >
                ...
                <div className="p-8 bg-white border-t border-slate-50">
                    <div className="flex items-center justify-between gap-4 mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-[9px] font-black uppercase text-black dark:text-slate-400 tracking-widest italic">{isBulk ? "Multiple Scans Active" : "Single Item Session"}</p>
                        </div>
