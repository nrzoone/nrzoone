      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6 group">
            ...
            <div>
                ...
                <p className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest leading-none">উৎপাদনে আছে (In-Production)</p>
            </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6 group">
            ...
            <div>
                ...
                <p className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest leading-none">মোট জমা হয়েছে (Received)</p>
            </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6 group">
            ...
            <div>
                ...
                <p className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest leading-none">বাকি লট (Lots Pending)</p>
            </div>
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-1 w-full lg:w-auto overflow-x-auto no-scrollbar">
          {[
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === tab.id ? 'bg-slate-950 text-white shadow-lg' : 'text-black dark:text-white hover:text-black dark:hover:text-white'}`}
            >
              {tab.label}
            </button>
          ))}
            ...
            {(masterData.cuttingStock || [])
              .filter(item => 
                ...
                <div className="col-span-full h-80 flex flex-col items-center justify-center bg-white dark:bg-slate-900 rounded-xl border-2 border-dashed border-slate-100 dark:border-slate-800 italic">
                    ...
                    <p className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest leading-none">কোনো রেকর্ড পাওয়া যায়নি (No Records)</p>
                </div>
              ) : (
                (masterData.cuttingStock || [])
                  .filter(item => 
                        ...
                        <div className="p-6 space-y-6 flex-1">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                    <p className="text-[9px] font-bold text-black dark:text-white uppercase tracking-widest mb-1 italic">রঙ (Color)</p>
                                    <p className="text-sm font-bold text-black dark:text-white truncate uppercase">{item.color}</p>
                                </div>
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                    <p className="text-[9px] font-bold text-black dark:text-white uppercase tracking-widest mb-1 italic">ইস্যুর তারিখ</p>
        ...
        {activeTab === "Design Registration" && (
           <div className="bg-slate-50 dark:bg-slate-800/30 flex flex-col items-center justify-center py-32 space-y-8 rounded-xl border-2 border-dashed border-slate-100 dark:border-slate-800">
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-[10px] font-bold tracking-[0.4em] text-black dark:text-white max-w-sm mx-auto uppercase italic">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold uppercase text-black dark:text-white tracking-widest ml-1">কাটার এর নাম (Cutter Name)</label>
                      <input 
                        className="premium-input !h-12 text-sm font-bold uppercase" 
