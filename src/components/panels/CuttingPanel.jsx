    ...
    <div className="space-y-10 pb-32 animate-fade-up px-1 md:px-4 text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6 group">
            ...
            <div>
                <p className="text-3xl font-bold tracking-tight text-black dark:text-white leading-none mb-1">{stats.inProduction.toLocaleString()}</p>
                <p className="text-[10px] font-bold text-black dark:text-slate-400 uppercase tracking-widest leading-none">উৎপাদনে আছে (In-Production)</p>
            </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6 group">
            ...
            <div>
                <p className="text-3xl font-bold tracking-tight text-black dark:text-white leading-none mb-1">{stats.received.toLocaleString()}</p>
                <p className="text-[10px] font-bold text-black dark:text-slate-400 uppercase tracking-widest leading-none">মোট জমা হয়েছে (Received)</p>
            </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6 group">
            ...
            <div>
                <p className="text-3xl font-bold tracking-tight text-black dark:text-white leading-none mb-1">{stats.pending.toLocaleString()}</p>
                <p className="text-[10px] font-bold text-black dark:text-slate-400 uppercase tracking-widest leading-none">বাকি লট (Lots Pending)</p>
            </div>
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-1 w-full lg:w-auto overflow-x-auto no-scrollbar">
          {[
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === tab.id ? 'bg-slate-950 text-white shadow-lg' : 'text-black dark:text-slate-400 hover:text-black dark:hover:text-white'}`}
            >
              {tab.label}
            </button>
          ))}
            ...
            {(masterData.cuttingStock || [])
              .filter(item => 
                ...
                <div className="col-span-full h-80 flex flex-col items-center justify-center bg-white dark:bg-slate-900 rounded-xl border-2 border-dashed border-slate-100 dark:border-slate-800 italic">
                    ...
                    <p className="text-[10px] font-bold text-black dark:text-slate-400 uppercase tracking-widest leading-none">কোনো রেকর্ড পাওয়া যায়নি (No Records)</p>
                </div>
              ) : (
                (masterData.cuttingStock || [])
                  .filter(item => 
                        ...
                        <div className="p-6 space-y-6 flex-1">
                            <div className="flex justify-between items-start">
                                <div className="space-y-1">
                                    <p className="text-[9px] font-bold text-black dark:text-slate-400 uppercase tracking-widest leading-none">ডিজাইন আইডি (Design)</p>
                                    <h4 className="text-2xl font-bold tracking-tight text-black dark:text-white uppercase leading-none">{item.design}</h4>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                    <p className="text-[9px] font-bold text-black dark:text-slate-400 uppercase tracking-widest mb-1 italic">রঙ (Color)</p>
                                    <p className="text-sm font-bold text-black dark:text-white truncate uppercase">{item.color}</p>
                                </div>
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                    <p className="text-[9px] font-bold text-black dark:text-slate-400 uppercase tracking-widest mb-1 italic">ইস্যুর তারিখ</p>
                            ...
                            <div className="flex justify-between items-center py-5 border-y border-slate-100 dark:border-slate-800 border-dashed">
                                <div className="flex flex-col">
                                     <span className="text-[9px] font-bold text-black dark:text-slate-400 uppercase tracking-widest mb-1 leading-none">বোরকা (Borka)</span>
                                ...
                                <div className="text-right">
                                     <span className="text-[9px] font-bold text-black dark:text-slate-400 uppercase tracking-widest mb-1 leading-none">হিজাব (Hijab)</span>
                                     <span className="text-3xl font-bold text-black dark:text-slate-400 leading-none">{item.hijab}</span>
                                </div>
                            </div>
                        </div>
        ...
        {activeTab === "Design Registration" && (
           <div className="bg-slate-50 dark:bg-slate-800/30 flex flex-col items-center justify-center py-32 space-y-8 rounded-xl border-2 border-dashed border-slate-100 dark:border-slate-800">
              ...
              <div className="text-center space-y-3">
                <h2 className="text-3xl font-bold uppercase tracking-tight text-black dark:text-white">নতুন কাটিং <span className="text-blue-600">আইডি যুক্ত করুন</span></h2>
                <p className="text-[10px] font-bold tracking-[0.4em] text-black dark:text-slate-400 max-w-sm mx-auto uppercase italic">
              ...
              <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-8 md:p-12 space-y-12">
                <div className="flex justify-between items-end">
                   <div>
                      ...
                      <p className="text-[10px] font-bold tracking-widest text-black dark:text-slate-400 uppercase italic">Advanced Pattern Utilization Analytics</p>
                   </div>
                   ...
                   {[
                     ...
                     <div key={i} className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800">
                        <div className="flex justify-between items-start mb-4">
                           <div className="w-10 h-10 bg-white dark:bg-slate-900 rounded-lg shadow-sm flex items-center justify-center text-black dark:text-slate-400">
                              <a.icon size={16} />
                           </div>
                           <span className="text-[8px] font-bold uppercase tracking-widest text-slate-300">NODE 0{i+1}</span>
                        </div>
                        <p className="text-[10px] font-bold text-black dark:text-slate-400 uppercase tracking-widest mb-1 italic leading-none">{a.label}</p>
              ...
              <div className="space-y-10">
                <div className="text-center space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-black dark:text-slate-400 tracking-widest mt-2 uppercase italic leading-none">Primary Material Injection Protocol</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold uppercase text-black dark:text-slate-400 tracking-widest ml-1">রঙ (Color Mapping)</label>
                      <select 
                        className="premium-input !h-12 text-sm font-bold uppercase" 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold uppercase text-black dark:text-slate-400 tracking-widest ml-1">লট নম্বর (Lot)</label>
                            <input 
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold uppercase text-black dark:text-slate-400 tracking-widest ml-1">তারিখ (Date)</label>
                            <input 
                                type="date" 
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold uppercase text-black dark:text-slate-400 tracking-widest ml-1">কাটার এর নাম (Cutter Name)</label>
                      <input 
                        className="premium-input !h-12 text-sm font-bold uppercase" 
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-xl border border-slate-100 dark:border-slate-800 flex flex-col shadow-inner">
                     <div className="flex justify-between items-center mb-6">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-black dark:text-slate-400">সাইজ লিস্ট (Size Matrix)</label>
                        <button 
                        ...
                        {entryData.sizes.map((s, idx) => (
                          <div key={idx} className="grid grid-cols-12 gap-3 items-center bg-white dark:bg-slate-900 p-2 rounded-xl border border-slate-100 dark:border-slate-800">
                             ...
                             <div className="col-span-4 relative border-l border-slate-100 dark:border-slate-800 px-3">
                                ...
                                <input 
                                    placeholder="0" type="number" 
                                    className="w-full bg-transparent h-10 text-xl font-bold text-center text-black dark:text-slate-400 outline-none" 
                                    value={s.hijab} 
                ...
                <div className="flex flex-col md:flex-row gap-4">
                   <button 
                    onClick={() => setShowModal(false)} 
                    className="flex-1 py-4 rounded-xl bg-white border-2 border-black text-black font-black uppercase text-[10px] tracking-widest hover:bg-black hover:text-white transition-all shadow-lg"
                   >
                    বাতিল (Close)
                   </button>
                   <button 
