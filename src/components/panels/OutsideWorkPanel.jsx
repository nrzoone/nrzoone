                    ...
                    <div key={item.id} className="flex flex-col h-full bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-6 shadow-md hover:border-black transition-all group animate-fade-up">
                        <div className="flex justify-between items-start mb-4">
                            <div className="space-y-0.5">
                                ...
                                <h4 className="text-xl font-black tracking-tighter text-[var(--text-primary)] uppercase leading-none italic truncate max-w-[150px]"><SafeText data={item.worker} /></h4>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-4">
                            <div className="bg-slate-50 dark:bg-slate-800 p-3 rounded-xl border border-white dark:border-slate-700">
                                ...
                                <p className="text-[11px] font-black text-[var(--text-primary)] truncate uppercase italic"><SafeText data={item.design} /></p>
                            </div>
                            <div className="bg-slate-50 dark:bg-slate-800 p-3 rounded-xl border border-white dark:border-slate-700">
                                <p className="text-[7.5px] font-black text-slate-400 uppercase tracking-widest mb-1.5 italic">কাজ/টাস্ক</p>
                                <p className="text-[11px] font-black text-[var(--text-primary)] truncate uppercase italic"><SafeText data={item.task} /></p>
                            </div>
                        </div>
                ...
                {receiveModal && (
                    <div className="fixed inset-0 z-[1000] bg-slate-950/60 backdrop-blur-md flex items-center justify-center p-4">
                        <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white dark:bg-slate-900 w-full max-w-md rounded-3xl shadow-2xl p-8 relative border border-slate-100 dark:border-slate-800">
                            ...
                            <h2 className="text-2xl font-black uppercase italic mb-8 tracking-tighter text-center"><SafeText data={receiveModal.worker} /> <span className="text-emerald-500">জমা নিন</span></h2>
                ...
                {payModal && (
                    <div className="fixed inset-0 z-[1000] bg-slate-950/60 backdrop-blur-md flex items-center justify-center p-4">
                        <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl p-6 relative border border-slate-100 dark:border-slate-800">
                            ...
                            <h2 className="text-xl font-black uppercase italic mb-6 tracking-tighter text-center"><SafeText data={payModal.worker} /> <span className="text-blue-500">পেমেন্ট</span></h2>
