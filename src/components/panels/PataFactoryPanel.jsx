    ...
    return (
        <div className="space-y-10 pb-32 animate-fade-up px-1 md:px-2 italic font-outfit text-[var(--text-primary)]">
                            ...
                            <div key={idx} className="bg-white dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 rounded-2xl p-6 space-y-6 shadow-md hover:border-black transition-all group animate-fade-up">
                                <div className="flex justify-between items-start">
                                    <div className="space-y-1">
                                        ...
                                        <h4 className="text-xl font-black tracking-tighter uppercase italic"><SafeText data={w} /></h4>
                                    </div>
                        ...
                        <div key={item.id} className="flex flex-col h-full bg-white dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 rounded-2xl p-6 shadow-md hover:border-black transition-all group animate-fade-up">
                            <div className="flex justify-between items-start mb-3 md:mb-4">
                                <div className="space-y-0.5">
                                    ...
                                    <h4 className="text-lg md:text-xl font-black tracking-tighter uppercase italic truncate max-w-[150px] md:max-w-[200px]"><SafeText data={item.worker} /></h4>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-2.5 mb-3 md:mb-4">
                                <div className="bg-slate-50 dark:bg-slate-800 p-2.5 md:p-3 rounded-xl border border-white dark:border-slate-700">
                                    ...
                                    <p className="text-[11px] font-black uppercase italic truncate"><SafeText data={item.design} /></p>
                                </div>
                                <div className="bg-slate-50 dark:bg-slate-800 p-2.5 md:p-3 rounded-xl border border-white dark:border-slate-700">
                                    <p className="text-[7.5px] font-black text-slate-400 uppercase tracking-widest mb-0.5 italic">টাইপ</p>
                                    <p className="text-[11px] font-black uppercase italic truncate"><SafeText data={item.pataType} /></p>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-3 md:py-4 border-y border-slate-50 dark:border-slate-800 border-dashed mb-3 md:mb-4">
                                <div>
                                    ...
                                    <p className="text-xl md:text-2xl font-black italic tracking-tighter leading-none"><SafeText data={item.pataQty} /> <span className="text-[9px] opacity-40">PCS</span></p>
                                </div>
            ...
            <AnimatePresence>
                ...
                {receiveModal && (
                    <div className="fixed inset-0 z-[1000] bg-slate-950/40 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto no-scrollbar">
                         ...
                         >
                             ...
                             <h2 className="text-xl font-black uppercase italic mb-8 text-center text-[var(--text-primary)]"><SafeText data={receiveModal.worker} /> <span className="text-emerald-500">জমা দিন</span></h2>
                ...
                {payModal && (
                    <div className="fixed inset-0 z-[1000] bg-slate-950/40 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto no-scrollbar">
                         ...
                         >
                             ...
                             <h2 className="text-xl font-black uppercase italic mb-8 text-center"><SafeText data={payModal} /> <span className="text-emerald-500">পেমেন্ট</span></h2>
                ...
                {showQR && <QRScanner onScanSuccess={(data) => { handleLotSearch(data); setShowQR(false); }} onClose={() => setShowQR(false)} SafeText={SafeText} />}
            </AnimatePresence>
