    ...
    <div className="space-y-8 pb-32 animate-fade-up px-1 md:px-4 text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="saas-card !p-6 flex items-center gap-6 group">
            ...
            <div>
                <p className="text-3xl font-bold tracking-tight text-black dark:text-white dark:text-white leading-none mb-1">{rawStock.roll}</p>
                <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest leading-none">পেপ্যার রোল (Rolls)</p>
            </div>
        </div>
        ...
        <div className="saas-card !p-6 flex items-center gap-6 group">
            ...
            <div>
                ...
                <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest leading-none">চলমান কাজ (Tasks)</p>
            </div>
        </div>
        ...
        <div className="saas-card !p-6 flex items-center gap-6 group font-outfit italic">
            ...
            <div>
                <p className="text-2xl font-bold tracking-tight text-black dark:text-white dark:text-white leading-none mb-1">৳{(workers.reduce((s, w) => s + getWorkerDue(w), 0)).toLocaleString()}</p>
                <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest leading-none">মোট বকেয়া (Total Due)</p>
            </div>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3 w-full lg:w-auto px-1.5">
          ...
          <div className="flex gap-2">
              <button 
                ...
                className="w-11 h-11 bg-white dark:bg-slate-800 text-black dark:text-white dark:text-white border border-slate-200 dark:border-slate-700 rounded-xl flex items-center justify-center hover:bg-slate-950 hover:text-white transition-all shadow-sm"
                title="কিউআর স্ক্যান"
              >
                 <Camera size={18} />
              </button>
                             ...
                             <div className="space-y-6 flex-1">
                                <div className="flex justify-between items-start">
                                    <div className="space-y-1">
                                        <p className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest leading-none">Pata Specialist</p>
                                        <h4 className="text-2xl font-bold tracking-tight text-black dark:text-white dark:text-white uppercase leading-none">{w}</h4>
                                    </div>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-xl border border-slate-100 dark:border-slate-800">
                                     <span className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest mb-1 block leading-none">বকেয়া মজুরি (Payable)</span>
                                     <span className={`text-4xl font-bold leading-none ${due > 0 ? 'text-black dark:text-white dark:text-white' : 'text-slate-200 dark:text-slate-700'}`}>৳{due.toLocaleString()}</span>
                                </div>
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {(view === 'active' ? activeEntries : historyEntries).length === 0 ? (
                    <div className="col-span-full py-32 flex flex-col items-center justify-center saas-card border-dashed">
                        ...
                        <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-[0.2em]">বর্তমানে কোনো রেকর্ড পাওয়া যায়নি</p>
                    </div>
                ) : (
                    (view === 'active' ? activeEntries : historyEntries).map((item, idx) => (
                        <div key={item.id || idx} className="saas-card flex flex-col group border-transparent hover:border-slate-950 dark:hover:border-white animate-fade-up">
                            <div className="space-y-6 flex-1">
                                <div className="flex justify-between items-start">
                                    <div className="space-y-1">
                                        <p className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest leading-none">কারিগর (Operator)</p>
                                        <h4 className="text-2xl font-bold tracking-tight text-black dark:text-white dark:text-white uppercase leading-none truncate max-w-[180px]">{item.worker}</h4>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                        <p className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest mb-1 italic">ডিজাইন আইডি</p>
                                        <p className="text-sm font-bold text-black dark:text-white dark:text-white truncate uppercase">{item.design} ({item.color})</p>
                                    </div>
                                    <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                        <p className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest mb-1 italic">লট ক্যাটাগরি</p>
                                        <p className="text-sm font-bold text-black dark:text-white dark:text-white truncate uppercase">{item.pataType} PATA</p>
                                    </div>
                                </div>
                                
                                <div className="flex justify-between items-center py-5 border-y border-slate-100 dark:border-slate-800 border-dashed">
                                    <div className="flex flex-col">
                                         <span className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest mb-1 leading-none">পরিমাণ (Output)</span>
                                         <span className="text-3xl font-bold text-black dark:text-white dark:text-white leading-none">{item.receivedQty || item.pataQty} পিস</span>
                                    </div>
                                    <div className="text-right">
                                         <span className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest mb-1 leading-none italic">তারিখ</span>
                            ...
                            <div className="flex gap-3 mt-8">
                                <button onClick={() => setPrintSlip(item)} className="w-11 h-11 bg-slate-50 dark:bg-slate-800 rounded-xl flex items-center justify-center text-black dark:text-white dark:text-white hover:bg-slate-950 hover:text-white transition-all border border-slate-100 dark:border-slate-800 shadow-sm" title="স্লিপ প্রিন্ট">
                                    <Printer size={16} />
                                </button>
                                {item.status === 'Pending' ? (
            ...
            <div className="w-full max-w-4xl my-auto bg-white dark:bg-slate-900 rounded-xl shadow-2xl p-8 md:p-12 relative overflow-hidden border border-slate-100 dark:border-slate-800 animate-fade-up">
              ...
              <div className="space-y-10">
                <div className="text-center space-y-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold tracking-tight text-black dark:text-white dark:text-white uppercase leading-none">নতুন কাজ <span className="text-blue-600">ইস্যু করুন</span></h2>
                    <p className="text-[10px] font-bold text-black dark:text-white dark:text-white tracking-widest mt-2 uppercase italic leading-none">Distributing Pata Production Units</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold uppercase text-black dark:text-white dark:text-white tracking-widest ml-1">কারিগর (Worker)</label>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold uppercase text-black dark:text-white dark:text-white tracking-widest ml-1">লট নম্বর (Lot ID)</label>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold uppercase text-black dark:text-white dark:text-white tracking-widest ml-1">তারিখ (Issue Date)</label>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                   <button 
                    onClick={() => setShowModal(false)} 
                    className="flex-1 py-4 rounded-xl bg-slate-50 dark:bg-slate-800 text-black dark:text-white dark:text-white font-bold uppercase text-[10px] tracking-widest hover:text-rose-500 transition-all border border-slate-100 dark:border-slate-800"
                   >
                    বাতিল (Cancel)
                   </button>
                   <button 
            ...
            <div className="w-full max-w-lg bg-white dark:bg-slate-900 rounded-xl shadow-2xl p-8 relative overflow-hidden border border-slate-100 dark:border-slate-800 animate-fade-up">
                <div className="text-center space-y-8">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold uppercase text-black dark:text-white dark:text-white leading-none">উৎপাদন জমা <span className="text-blue-600">নিন (Receive)</span></h3>
                        <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest italic mt-2 leading-none">{receiveModal.worker} - Lot #{receiveModal.lotNo}</p>
                    </div>
                    <form onSubmit={handleReceive} className="space-y-8">
                        <div className="bg-slate-50 dark:bg-slate-800/50 p-10 rounded-xl text-center border border-slate-100 dark:border-slate-800 shadow-inner">
                            <label className="text-[10px] font-bold uppercase text-black dark:text-white dark:text-white tracking-widest block mb-4">স্বাক্ষরিত পরিমাণ (Confirm Quantity)</label>
                            <input name="rQty" type="number" defaultValue={receiveModal.pataQty} className="w-full text-center text-6xl font-bold bg-transparent border-none text-black dark:text-white dark:text-white outline-none leading-none h-20" autoFocus />
                        </div>
                        <div className="flex flex-col gap-3">
                            ...
                            <button type="button" onClick={() => setReceiveModal(null)} className="w-full py-4 text-black dark:text-white dark:text-white font-bold text-[10px] uppercase rounded-xl hover:text-rose-500 transition-all font-outfit">বাতিল করুন</button>
                        </div>
                    </form>
                </div>
            </div>
          ...
          <div className="fixed inset-0 z-[1000] bg-slate-950/40 backdrop-blur-md flex items-center justify-center p-4">
            <div className="w-full max-w-lg bg-white dark:bg-slate-900 rounded-xl shadow-2xl p-10 relative overflow-hidden border border-slate-100 dark:border-slate-800 animate-fade-up">
                <div className="text-center space-y-8">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold uppercase text-black dark:text-white dark:text-white leading-none">মজুরি <span className="text-blue-600">পরিশোধ করুন</span></h3>
                        <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest italic mt-2 leading-none font-outfit">{payModal}</p>
                    </div>
                    <form onSubmit={handleConfirmPayment} className="space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-[9px] font-bold uppercase text-black dark:text-white dark:text-white tracking-widest ml-1">তারিখ</label>
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[9px] font-bold uppercase text-black dark:text-white dark:text-white tracking-widest ml-1">নোট (Optional)</label>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button type="button" onClick={() => setPayModal(null)} className="w-full py-4 text-black dark:text-white dark:text-white font-bold text-[10px] uppercase rounded-xl hover:text-rose-500 transition-all font-outfit">বাতিল করুন</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div className="w-full max-w-2xl bg-white dark:bg-slate-900 rounded-xl shadow-2xl p-8 relative overflow-hidden border border-slate-100 dark:border-slate-800 animate-fade-up">
                <div className="space-y-8">
                    <div className="flex justify-between items-center pb-6 border-b border-slate-100 dark:border-slate-800">
                        <div>
                            <h3 className="text-2xl font-bold uppercase text-black dark:text-white dark:text-white leading-none">কারিগর <span className="text-blue-600">লেজার (Ledger)</span></h3>
                            <p className="text-[10px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest italic mt-2 leading-none font-outfit">{ledgerModal} - Audit Log</p>
                        </div>
                        <button 
                            onClick={() => setLedgerModal(null)} 
                            className="p-2.5 bg-slate-50 dark:bg-slate-800 rounded-xl hover:bg-rose-500 hover:text-white transition-all text-black dark:text-white dark:text-white shadow-sm"
                        >
                            <X size={20} />
                        </button>
                    </div>
                    ...
                    <div className="max-h-[40vh] overflow-y-auto pr-2 space-y-3 no-scrollbar">
                        {(masterData.pataEntries || []).filter(e => e.worker === ledgerModal && e.status === 'Received').map((e, idx) => (
                            <div key={idx} className="flex justify-between items-center p-5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 group hover:border-emerald-500/30 transition-all">
                                <div className="space-y-1">
                                    <p className="text-[9px] font-bold text-black dark:text-white dark:text-white uppercase tracking-widest italic leading-none">{e.receiveDate}</p>
                                    <h4 className="text-sm font-bold uppercase text-black dark:text-white dark:text-white">{e.design} ({e.receivedQty || e.pataQty} পিস)</h4>
                                </div>
                                <div className="text-right">
