        ...
        <div className="premium-card group hover:shadow-premium !p-8 md:!p-10">
            <div className="flex justify-between items-start mb-10">
                <div className="space-y-1">
                    <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-black dark:text-white">Operational Node</p>
            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="bg-[var(--bg-primary)] p-6 md:p-8 rounded-3xl shadow-[var(--neu-concave)]">
                    <p className="text-[9px] font-bold uppercase tracking-widest text-black dark:text-white mb-2">In Progress</p>
                    <p className="text-3xl md:text-5xl font-black tracking-tighter leading-none italic text-[var(--text-primary)]">{pending}</p>
                </div>
                <div className="bg-[var(--bg-primary)] p-6 md:p-8 rounded-3xl shadow-[var(--neu-concave)]">
                    <p className="text-[9px] font-bold uppercase tracking-widest text-black dark:text-white mb-2">{label2.toUpperCase()}</p>
            ...
            {bill > 0 && (
                <div className="mt-10 pt-8 border-t border-[var(--border)]">
                    <p className="text-[9px] font-bold uppercase tracking-[0.3em] text-black dark:text-white mb-3">Accumulated Revenue</p>
        ...
        >
            <div className="flex items-center gap-6 md:gap-8 text-left">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-bold text-black dark:text-white uppercase tracking-[0.4em] italic">{sub}</p>
                </div>
            </div>
